...
public static class SerializedPropertyExtensions
{
    ...
    public static void AddToObjectArray<T> (this SerializedProperty arrayProperty, T elementToAdd, bool repeatElements = false)
        where T : Object
    {
    ...
    public static int IsObjectInArray<T>(this SerializedProperty arrayProperty, T elementToCheck) where T : Object {
        ...
        for (int i = 0; i < arrayProperty.arraySize; i++) {
            ...
            if (elementProperty.objectReferenceValue == elementToCheck) {
                isInArray = i;
            }
        }
