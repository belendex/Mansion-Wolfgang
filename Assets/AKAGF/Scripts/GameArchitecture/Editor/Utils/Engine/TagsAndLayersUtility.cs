...
/// <summary>
/// The code below does the following when creating a tag or layer:
/// Checks to see if there is still "room" in the property to write another element
...
/// The removal of a tag or layer works similarly to the steps described above, except we unset the property value: 
/// For layers, we set the value to an empty string "" and for tags, we remove the element at the index of our match.
/// 
/// link: https://answers.unity.com/questions/33597/is-it-possible-to-create-a-tag-programmatically.html
/// 
/// </summary>
